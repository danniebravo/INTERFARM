...
urlpatterns = [
    ...
    path("produccion/leche/dia", views.update_milk_day, name="milk-day.update"),
    path("produccion/leche/total-diario/<int:pk>/editar", views.update_daily_milk, name="milk-daily.update"),
    path("produccion/carne/<int:pk>/editar", views.update_meat, name="meat.update"),
